...
namespace Generator {
    public class UInt128Wrapper {
        ...
        public static implicit operator byte(UInt128Wrapper value) => (byte) value.Value;
        public static implicit operator sbyte(UInt128Wrapper value) => (sbyte) value.Value;
        public static implicit operator ushort(UInt128Wrapper value) => (ushort) value.Value;
        public static implicit operator short(UInt128Wrapper value) => (short) value.Value;
        public static implicit operator uint(UInt128Wrapper value) => (uint) value.Value;
        public static implicit operator int(UInt128Wrapper value) => (int) value.Value;
        public static implicit operator ulong(UInt128Wrapper value) => (ulong) value.Value;
        public static implicit operator long(UInt128Wrapper value) => (long) value.Value;
    ...
    public class Int128Wrapper {
        ...
        public static implicit operator byte(Int128Wrapper value) => (byte) (uint) value.Value;
        public static implicit operator sbyte(Int128Wrapper value) => (sbyte) value.Value;
        public static implicit operator ushort(Int128Wrapper value) => (ushort) (uint) value.Value;
        public static implicit operator short(Int128Wrapper value) => (short) value.Value;
        public static implicit operator uint(Int128Wrapper value) => (uint) value.Value;
        public static implicit operator int(Int128Wrapper value) => (int) value.Value;
        public static implicit operator ulong(Int128Wrapper value) => (ulong) value.Value;
        public static implicit operator long(Int128Wrapper value) => (long) value.Value;
